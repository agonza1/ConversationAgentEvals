...
The opt-in Holy Guacamole SignalWire target drives `https://holyguacamole.signalwire.me/` through a gated browser WebRTC executor and records current-run caller/target audio, transcript, timing, provenance, and vCon evidence; see [docs/signalwire-holyguacamole-target-execution.md](docs/signalwire-holyguacamole-target-execution.md).
