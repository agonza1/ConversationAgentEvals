...
Execute-stage **local Pipecat SmallWebRTC audio in/out hooks** (no FreeSWITCH required for CI) are documented in [docs/execution-audio-webrtc.md](docs/execution-audio-webrtc.md).
