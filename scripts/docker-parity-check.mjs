...
requireIncludes('api service', api, 'RTC_ASR_BASE_URL: ${RTC_ASR_BASE_URL:-}');
requireIncludes('api service', api, 'KOKORO_BASE_URL: ${KOKORO_BASE_URL:-}');
requireIncludes('api service', api, 'REFERENCE_AGENT_INTERNAL_TOKEN: ${REFERENCE_AGENT_INTERNAL_TOKEN:-}');
requireIncludes('api service', api, 'host.docker.internal:host-gateway');
...
requireIncludes('pipecat service', pipecat, 'KOKORO_BASE_URL: ${KOKORO_BASE_URL:-}');
requireIncludes('pipecat service', pipecat, 'REFERENCE_AGENT_INTERNAL_TOKEN: ${REFERENCE_AGENT_INTERNAL_TOKEN:-}');
requireIncludes('pipecat service', pipecat, 'host.docker.internal:host-gateway');
